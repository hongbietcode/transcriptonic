...
> Zoom and Teams transcripts in beta. <a href="https://github.com/hongbietcode/transcriptonic/wiki/Zoom-and-Teams-beta-testing" target="_blank">Learn more</a>.

![marquee-large](/assets/banner.png)

Extension status: 🟢 OPERATIONAL (v0.1.0)
...
### Real-time Transcription in Google Meet
![Google Meet Transcription](/assets/screenshot-meet.png)

### Extension Popup & Settings
![Extension Popup](/assets/popup-ui.png)
...
1. Clone this repository:
   ```bash
   git clone https://github.com/hongbietcode/transcriptonic.git
   ```
...
-   [Google Docs integration guide](docs/google-docs-integration-guide.md)
...
This project is a fork of [TranscripTonic](https://github.com/vivek-nexus/transcriptonic) by vivek-nexus.
