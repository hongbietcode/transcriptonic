...
declare namespace chrome {
	...
	export namespace _debugger {
		 ...
		 * Can return its result via Promise since Chrome 96.
		 */
		export function sendCommand(target: DebuggerSession, method: string, commandParams?: Object): Promise<Object | undefined>;
		export function sendCommand(target: DebuggerSession, method: string, commandParams?: Object, callback?: (result?: Object) => void): void;
	...
	export namespace devtools.panels {
		 ...
		 * @param callback A function that is called when the resource has been successfully loaded.
		 */
		export function openResource(url: string, lineNumber: number, columnNumber: number, callback?: (response: unknown) => unknown): void;
		/**
		 * @since Chrome 59
	...
	export namespace documentScan {
		...
		export function closeScanner<T = string>(scannerHandle: T, callback: (response: CloseScannerResponse<T>) => void): void;
		...
		export function getOptionGroups<T = string>(scannerHandle: T, callback: (response: GetOptionGroupsResponse<T>) => void): void;
		...
		export function setOptions<T = string>(scannerHandle: T, options: OptionSetting[], callback: (response: SetOptionsResponse<T>) => void): void;
		...
		export function startScan<T = string>(scannerHandle: T, options: StartScanOptions, callback: (response: StartScanResponse<T>) => void): void;
	}
	...
	export namespace downloads {
		...
		export interface DownloadDeterminingFilenameEvent
			extends chrome.events.Event<(downloadItem: DownloadItem, suggest: (suggestion?: DownloadFilenameSuggestion) => void) => void> {}
	...
	export namespace fileSystemProvider {
		...
		export const onAbortRequested: events.Event<
			(options: AbortRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onAddWatcherRequested: events.Event<
			(options: AddWatcherRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onCloseFileRequested: events.Event<
			(options: CloseFileRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onConfigureRequested: events.Event<
			(options: ConfigureRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onCopyEntryRequested: events.Event<
			(options: CopyEntryRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onCreateDirectoryRequested: events.Event<
			(options: CreateDirectoryRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onCreateFileRequested: events.Event<
			(options: CreateFileRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onDeleteEntryRequested: events.Event<
			(options: DeleteEntryRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onExecuteActionRequested: events.Event<
			(options: ExecuteActionRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		 ...
		 * @since Chrome 44
		 */
		export const onMountRequested: events.Event<(successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void>;
		...
		export const onMoveEntryRequested: events.Event<
			(options: MoveEntryRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onRemoveWatcherRequested: events.Event<
			(options: RemoveWatcherRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onTruncateRequested: events.Event<
			(options: TruncateRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
		...
		export const onUnmountRequested: events.Event<
			(options: UnmountRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;

		/** Raised when writing contents to a file opened previously with `openRequestId` is requested. */
		export const onWriteFileRequested: events.Event<
			(options: WriteFileRequestedOptions, successCallback: () => void, errorCallback: (error: `${ProviderError}`) => void) => void
		>;
	}
	...
	export namespace notifications {
		 ...
		 */
		export function create(notificationId: string, options: NotificationOptions<true>, callback?: (notificationId: string) => void): void;
		/**
		 * Creates and displays a notification.
		 * @param notificationId Identifier of the notification. If not set or empty, an ID will automatically be generated. If it matches an existing notification, this method first clears that notification before proceeding with the create operation.
		 * The notificationId parameter is required before Chrome 42.
	...
	export namespace printerProvider {
		...
		export interface CapabilityRequestedEvent
			extends chrome.events.Event<(printerId: string, resultCallback: (capabilities: PrinterCapabilities) => void) => void> {}
    ...
    */
	...
	export namespace runtime {
		...
		export interface ExtensionMessageEvent
			extends chrome.events.Event<(message: any, sender: MessageSender, sendResponse: (response?: any) => void) => void> {}
		 ...
		 * Parameter response: The JSON response object sent by the handler of the message. If an error occurs while connecting to the extension, the callback will be called with no arguments and runtime.lastError will be set to the error message.
		 */
		export function sendMessage<M = any, R = any>(message: M, options: MessageOptions, responseCallback: (response: R) => void): void;
		/**
		 * Sends a single message to event listeners within your extension/app or a different extension/app. Similar to runtime.connect but only sends a single message, with an optional response. If sending to your extension, the runtime.onMessage event will be fired in each page, or runtime.onMessageExternal, if a different extension. Note that extensions cannot send messages to content scripts using this method. To send messages to content scripts, use tabs.sendMessage.
		 * @since Chrome 26
	...
	export namespace storage {
		...
		export interface StorageArea {
			 ...
			 */
			getBytesInUse<T = { [key: string]: any }>(keys: keyof T | Array<keyof T> | null, callback: (bytesInUse: number) => void): void;
			/**
			 * Gets the amount of space (in bytes) being used by one or more items.
			 * @param callback Callback with the amount of space being used by storage, or on failure (in which case runtime.lastError will be set).
			 * Parameter bytesInUse: Amount of space being used in storage, in bytes.
			 ...
			 * @since MV3
			 */
			get<T = { [key: string]: any }>(keys?: NoInferX<keyof T> | Array<NoInferX<keyof T>> | Partial<NoInferX<T>> | null): Promise<T>;
			/**
			 * Gets one or more items from storage.
			 * @param keys A single key to get, list of keys to get, or a dictionary specifying default values.
			 * An empty list or object will return an empty result object. Pass in null to get the entire contents of storage.
		...
		export interface StorageAreaChangedEvent extends chrome.events.Event<(changes: { [key: string]: StorageChange }) => void> {}
	...
	export namespace webRequest {
		interface WebRequestEvent<T extends Function, U extends string[]> extends Omit<chrome.events.Event<T>, "addListener"> {
		...
		export type _WebResponseHeadersEvent<T extends WebResponseHeadersDetails> = WebRequestEvent<(details: T) => void, string[]>;
	...
	export namespace declarativeNetRequest {
		...
		export function testMatchOutcome(request: TestMatchRequestDetails, callback: (result: TestMatchOutcomeResult) => void): void;
